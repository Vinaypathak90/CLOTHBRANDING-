...
import { useGoogleLogin } from '@react-oauth/google'; // 🔥 Programmatic hook import kiya
import axios from 'axios'; // For direct external Google API user info fetch
...
export default function AuthPage() {
  ...
  // Storage for the OTP generated by the system for fresh signups
  ...
  // ====================================================================
  // 🔥 GOOGLE OAUTH POP-UP HANDSHAKE PIPELINE
  // ====================================================================
  // ====================================================================
  ...
  const triggerGoogleOAuthSync = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      try {
        ...
        // 3. 🔥 FIX: Direct seamless routing bypasses any strict return status validations
  ...
  const handleSignupVerify = async (e) => {
    ...
    if (formData.otp !== systemGeneratedOtp) {
    ...
    try {
      ...
      setError(err || 'Registration failed during finalization.');
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="w-full max-w-md">
          ...
          {view === 'login' && (
            <form onSubmit={handleLogin} className="flex flex-col gap-5">
              ...
              {/* 🔥 FIXED: Programmatic clean popup trigger button replaces vanilla component tag */}
